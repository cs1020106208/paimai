...
<body>
<form action="${pageContext.request.contextPath}/auction/insertAuction.do" method="post" enctype="multipart/form-data" onsubmit="return form()">
<div class="wrap">
  <!-- main begin-->
  <div class="sale">
      ...
      <div class="login logns produce">
        <h1 class="blues">拍卖品信息</h1>
          <dl>
            ...
            <dd class="dds">
              <label>拍卖品图片：</label>
               <div class="lf salebd"><a href="${pageContext.request.contextPath}/upload.do">
