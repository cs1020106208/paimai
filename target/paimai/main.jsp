...
<!-- main begin-->
  ...
  <form action="${pageContext.request.contextPath}/auction/selectAllAuction.do" method="post">
  <div class="forms">
  ...
  <div class="items">
      ...
      <ul class="rows">
        ...
        <li class="borderno red">
           <a href="${pageContext.request.contextPath}/selectAll.do?auction_id=${auction.auction_id}">竞拍</a>
 		 <c:if test="${sessionScope.user.user_is_admin==1}">
		   <a href="${pageContext.request.contextPath}/auction/selectOneAuction.do?auction_id=${auction.auction_id}" title="修改" onclick="dele();">修改</a>|
          	<a href="${pageContext.request.contextPath}/auction/deleteAuction.do?auction_id=${auction.auction_id}" title="删除" onclick="abc();">删除</a>
       	</c:if>
        </li>
